...
// // import { ListStatesComponent } from '../states/list-states/list-states.component';
// import { StateListItemComponent } from '../states/state-list-item/state-list-item.component';

// import { ContractListItemComponent } from '../contract/contract-list-item/contract-list-item.component';

// import { CertificateListItemComponent } from '../certificate/certificate-list-item/certificate-list-item.component';
...
import { DeviceListItemComponent } from '../device/device-list-item/device-list-item.component';
...
export class ExplorerComponent implements OnInit {
  ...
  // views = ['transactions', 'batches', 'blocks','state','user'];
  // views = ['transactions', 'property', 'user', 'certificate', 'contract'];
  views = ['transactions', 'user', 'device'];
  ...
  listViewComponents = {
    ...
    // 'state': StateListItemComponent,
    'user': UserListItemComponent,
    'device': DeviceListItemComponent
    // 'certificate': CertificateListItemComponent,
    // 'contract': ContractListItemComponent,
    // 'property': PropertyListItemComponent,
  ...
  ngOnInit() {
    ...
    this.activatedRoute.queryParams.subscribe((queryParams: Params) => {
      const viewType = queryParams['view'];
  ...
  updateView(data: any) {
    ...
    this.items = data;
    this.navTotalItems = data.length;
